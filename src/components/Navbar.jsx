        ...
        >
            <div className="w-full max-w-6xl mx-auto flex items-center justify-between">
                ...
                <ul className="flex items-center sm:gap-10 gap-6">
                  ...
                  <li>
                    <a href="#tentang" className="text-white sm:text-lg text-base font-medium hover:text-violet-400 transition">
                      Skill
                    </a>
                  </li>
                  <li>
                    <a href="#sertifikat" className="text-white sm:text-lg text-base font-medium hover:text-violet-400 transition">
                      Sertifikat
                    </a>
                  </li>
                  <li>
                    <a href="#kontak" className="text-white sm:text-lg text-base font-medium hover:text-violet-400 transition">
                      Kontak
                    </a>
                  </li>
                </ul>
